...
/**
 * This is the item provider adapter for a {@link party.Drink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DrinkItemProvider extends SustenanceItemProvider {
	/**
	...
	protected void addAlcoholContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Drink_alcoholContent_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Drink_alcoholContent_feature",
								"_UI_Drink_type"),
						PartyPackage.Literals.DRINK__ALCOHOL_CONTENT, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Drink_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Drink_type_feature", "_UI_Drink_type"),
						PartyPackage.Literals.DRINK__TYPE, true, false, false,
